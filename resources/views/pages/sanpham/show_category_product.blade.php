    ...
    <div class="container-fluid"> <!-- /*CHỌN LOẠI HIỂN THỊ*/ -->
        <div class="filter-bar">
            ...
            <div class="category">
                ...
                <form method="GET">
                    ...
                    <input type="hidden" id="selectedColors" name="selectedColors"
                        value="{{ json_encode($selectedColors) }}">
                    <ul class="">
            ...
            <div class="category">
                ...
                <input type="hidden" class="price_from" name="price_from" id="price_from"
                    value="{{ $min_price_value }}">
                <input type="hidden" class="price_to" name="price_to" id="price_to"
            ...
            <form action="{{ URL::to('/tim-kiem') }}" method="get">
                ...
                <div class="search_product">
                    <div class="input-group flex-nowrap">
                        <input type="text" class="form-control search_input_product"
                            placeholder="Tìm kiếm sản phẩm" aria-describedby="addon-wrapping" name="keywords_submit">
        ...
        $(document).ready(function() {
            $("#slider-range").slider({
                ...
                slide: function(event, ui) {
                    $("#amount").val(addPlus(ui.values[0]) + " VNĐ" + " - " + addPlus(ui.values[1]) +
                        " VNĐ"); //cộng/ trừ giá trị vào khi di chuyển
                    $('#price_from').val(ui.values[0]);
                    $('#price_to').val(ui.values[1]);
                }
            });
            $("#amount").val(addPlus($("#slider-range").slider("values", 0)) + " VNĐ" + " - " + addPlus($(
                "#slider-range").slider("values", 1)) + " VNĐ"); //hiển thị ra bên ngoài
